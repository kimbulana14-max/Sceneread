        ...
        <Card padding="p-0">
          ...
          <div className="divide-y divide-border/30">
            <button 
              ...
              className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-overlay-2 transition-colors"
            >
        ...
        <Card padding="p-0">
          ...
          <div className="px-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => updateSettings({ colorTheme: 'dark' })}
              ...
              <button
                onClick={() => updateSettings({ colorTheme: 'light' })}
                className={`flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-medium transition-all ${
                  settings.colorTheme === 'light'
                    ? 'bg-accent text-white'
                    : 'bg-bg-surface text-text-muted hover:text-text'
    ...
    <div className={`rounded-xl border p-4 transition-all ${
      ...
      <div className="flex items-start gap-3">
        <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
          unlocked ? 'bg-overlay-10' : 'bg-bg-elevated'
        }`}>
          <AchievementIcon 
            icon={achievement.icon} 
