...
export function WelcomeSplash({ name, onComplete }: WelcomeSplashProps) {
  ...
  const quotes: { text: string; author: string }[] = [
    ...
    { text: "Acting is standing up naked and turning around very slowly.", author: "Rosalind Russell" },
    { text: "The best acting is when you forget you're watching acting.", author: "Ian McKellen" },
    { text: "To be a good actor you have to be something like a criminal.", author: "Cate Blanchett" },
    { text: "Every scene should be able to answer three questions: who wants what from whom?", author: "David Mamet" },
    { text: "Acting is not about being famous, it's about exploring the human soul.", author: "Annette Bening" },
    { text: "The actor must know that since he himself is the instrument, he must play on it to serve the character.", author: "Uta Hagen" },
    { text: "In the theatre, the audience wants to be surprised — by transformation.", author: "Anne Bogart" },
    { text: "You must be willing to risk everything to really express it all.", author: "John Cassavetes" },
    { text: "Acting is half shame, half glory. Shame at exhibiting yourself, glory when you can forget yourself.", author: "John Gielgud" },
    { text: "The stage is a magic circle where only the most real things happen.", author: "P.L. Travers" },
    { text: "What is acting but lying, and what is good acting but convincing lying?", author: "Laurence Olivier" },
    { text: "Take it from the top. And this time, mean it.", author: "Theatre Proverb" },
    { text: "The rehearsal room is the safest place in the world.", author: "Peter Brook" },
    { text: "Your preparation is your freedom.", author: "Stella Adler" },
    { text: "Listen with your whole body. React with your whole soul.", author: "Lee Strasberg" },
    { text: "Theatre is the art of looking at ourselves.", author: "Augusto Boal" },
    { text: "The play is not in the words, it's in you.", author: "Stella Adler" },
    { text: "Stop trying to be interesting. Be interested.", author: "Sanford Meisner" },
    { text: "Every time I start a new role, I feel like I've never acted before.", author: "Philip Seymour Hoffman" },
    { text: "Acting is the least mysterious of all crafts. Whenever we want something from somebody, we act.", author: "Marlon Brando" },
    { text: "The human body is the best picture of the human soul.", author: "Ludwig Wittgenstein" },
    { text: "Know your lines and don't bump into the furniture.", author: "Spencer Tracy" },
    { text: "If you really do want to be an actor who can satisfy himself, be prepared to be dissatisfied.", author: "Michael Caine" },
    { text: "There are no small parts, only small actors.", author: "Konstantin Stanislavski" },
    { text: "Speak the speech, I pray you, as I pronounced it to you: trippingly on the tongue.", author: "William Shakespeare" },
    { text: "The truth of the moment is what good acting is all about.", author: "Sandra Bullock" },
    { text: "A good actor gives the audience a chance to discover things.", author: "Robert Duvall" },
    { text: "The camera can photograph thought.", author: "Dirk Bogarde" },
    { text: "Acting is the most personal of our crafts.", author: "Uta Hagen" },
  ]
